...
function analyzeJavaScript(input) {
    return analyze(input, parser_1.parseJavaScriptSourceFile);
}
exports.analyzeJavaScript = analyzeJavaScript;
function analyzeTypeScript(input) {
    return analyze(input, input.filePath.endsWith('.vue') ? parser_1.parseVueSourceFile : parser_1.parseTypeScriptSourceFile);
}
